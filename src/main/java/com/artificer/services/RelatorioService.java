...
public class RelatorioService {
	...
	public byte[] gerarRelatorioVendaEmitidas(PeriodoRelatorio periodoRelatorio) throws Exception {
		...
		InputStream inputStream = this.getClass().getResourceAsStream("/relatorios/relatorio_pedidos_emitidos.jasper");
