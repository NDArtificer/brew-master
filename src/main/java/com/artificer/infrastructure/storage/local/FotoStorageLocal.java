package com.artificer.infrastructure.storage.local;
...
import com.artificer.infrastructure.storage.StorageProperties;
...
public class FotoStorageLocal implements FotoStorageService {
	...
	public String getUrl(String nomeFoto) {
        return String.format("http://localhost:8080/fotos/%s", nomeFoto);
	}
